# tcc-orientacao-cronograma

## Purpose

Capacidade de criar e manter o cronograma de marcos temporais de um TCC por retroplanning a partir da data de defesa, com datas-alvo revisáveis, registradas no Anexo de Acompanhamento.
